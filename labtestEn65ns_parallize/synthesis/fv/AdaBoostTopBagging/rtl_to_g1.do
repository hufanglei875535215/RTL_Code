...
usage -auto -elapse
set log file fv/AdaBoostTopBagging/rtl_to_g1.log -replace
tclmode
...
if {$ver < 13.10} {
vpx read design  -verilog2k  -define SYNTHESIS  -golden -lastmod -noelab \
	../src/AdaBoostBagging_Weigth_Memory.v
} else {
vpx read design  -verilog2k  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab \
	../src/AdaBoostBagging_Weigth_Memory.v
}
...
elaborate design -golden -root AdaBoostTopBagging -rootonly \

tclmode
if {$ver < 13.10} {
vpx read design -verilog -revised -lastmod -noelab \
	-unzip fv/AdaBoostTopBagging/g1.v.gz
} else {
...
elaborate design -revised -root AdaBoostTopBagging
...
write hier_compare dofile fv/AdaBoostTopBagging/hier_rtl_to_g1.do \
...
run hier_compare fv/AdaBoostTopBagging/hier_rtl_to_g1.do -analyze_abort  -dynamic_hierarchy
