...
testbench_Path="${path2}/src/AdaBoostTopBagging_Test.v"
...
sed -n "/^AdaBoostTop/p" AdaBoost_Top_tcf_tcf.power  >> testfile.txt
sed -n "/^  m1/p" AdaBoost_Top_tcf_tcf.power  >> testfile.txt
sed -n "/^  m2/p" AdaBoost_Top_tcf_tcf.power  >> testfile.txt
sed -n "/^  m3/p" AdaBoost_Top_tcf_tcf.power  >> testfile.txt
sed -n "/^  bagging1/p" Adaboost_Top_tcf_tcf.power  >> testfile.txt
sed -n "/^  bagging2/p" AdaBoost_Top_tcf_tcf.power  >> testfile.txt
sed -n "/^  bagging3/p" AdaBoost_Top_tcf_tcf.power  >> testfile.txt
echo "-------------------the area of the Top module is---------------------- " >>testfile.txt
tail -n 2 AdaBoost_Top_tcf_tcf.gates >> testfile.txt
echo "----------------------------------------------------------------------" >> testfile.txt
