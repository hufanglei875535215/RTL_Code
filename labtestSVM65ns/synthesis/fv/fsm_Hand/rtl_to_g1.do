...
usage -auto -elapse
set log file fv/fsm_Hand/rtl_to_g1.log -replace
tclmode
...
elaborate design -golden -root fsm_Hand -rootonly \

tclmode
if {$ver < 13.10} {
vpx read design -verilog -revised -lastmod -noelab \
	-unzip fv/fsm_Hand/g1.v.gz
} else {
...
elaborate design -revised -root fsm_Hand
...
write hier_compare dofile fv/fsm_Hand/hier_rtl_to_g1.do \
...
run hier_compare fv/fsm_Hand/hier_rtl_to_g1.do -analyze_abort  -dynamic_hierarchy
