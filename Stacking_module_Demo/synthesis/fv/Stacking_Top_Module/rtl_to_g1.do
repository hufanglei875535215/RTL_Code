...
usage -auto -elapse
set log file fv/Stacking_Top_Module/rtl_to_g1.log -replace
tclmode
...
elaborate design -golden -root Stacking_Top_Module -rootonly

tclmode
if {$ver < 13.10} {
vpx read design -verilog -revised -lastmod -noelab \
	-unzip fv/Stacking_Top_Module/g1.v.gz
} else {
...
elaborate design -revised -root Stacking_Top_Module
...
write hier_compare dofile fv/Stacking_Top_Module/hier_rtl_to_g1.do \
...
run hier_compare fv/Stacking_Top_Module/hier_rtl_to_g1.do -analyze_abort  -dynamic_hierarchy
