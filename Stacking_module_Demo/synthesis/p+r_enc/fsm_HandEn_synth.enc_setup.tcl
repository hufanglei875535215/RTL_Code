...
# Created by Encounter(R) RTL Compiler on 12/03/2018 11:28:32
#
#####################################################################
...
# Design Import
###########################################################
source ./p+r_enc/fsm_HandEn_synth.globals
init_design


# Mode Setup
###########################################################
source ./p+r_enc/fsm_HandEn_synth.mode

# Import list of instances with subdesigns having boundary optimization disabled
################################################################################
setOptMode -keepPort ./p+r_enc/fsm_HandEn_synth.boundary_opto.tcl 


# Import list of size_only instances
######################################
setOptMode -sizeOnlyFile ./p+r_enc/fsm_HandEn_synth.size_ok.tcl 
