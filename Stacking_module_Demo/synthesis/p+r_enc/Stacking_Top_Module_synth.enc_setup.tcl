...
# Created by Encounter(R) RTL Compiler on 12/25/2018 12:10:04
#
#####################################################################
...
# Design Import
###########################################################
source ./p+r_enc/Stacking_Top_Module_synth.globals
init_design


# Mode Setup
###########################################################
source ./p+r_enc/Stacking_Top_Module_synth.mode

# Import list of instances with subdesigns having boundary optimization disabled
################################################################################
setOptMode -keepPort ./p+r_enc/Stacking_Top_Module_synth.boundary_opto.tcl 


# Import list of size_only instances
######################################
setOptMode -sizeOnlyFile ./p+r_enc/Stacking_Top_Module_synth.size_ok.tcl 
