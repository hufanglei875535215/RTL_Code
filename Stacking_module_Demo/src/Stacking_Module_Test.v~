...
reg signed [9:0] class_weight1;
reg signed [9:0] class_weight2;
reg signed [9:0] class_weight3;
reg signed [9:0] class_bias;
reg signed [9:0] thred;
reg [4:0] i;
reg[4:0] j;
reg[4:0] k;
reg [4:0] ii;
...
initial
begin
	$readmemb("../src/stacking_base_weight1.txt",weight1M);
	$readmemb("../src/stacking_base_weight2.txt",weight2M);
	$readmemb("../src/stacking_base_weight3.txt",weight3M);
end
initial 
begin
/*
...
initial
begin
class_weight1=10'd75;
class_weight2=10'd350;
class_weight3=10'd281;
class_bias=10'd155;
thred=10'd243;
end
...
read2=0;
read3=0;
weight1=9'b111010001;
weight2=9'b110100111;
weight3=9'b110100001;
en=0;
i=0;
j=0;
k=0;
