...
# Created by Encounter(R) RTL Compiler on 12/04/2018 15:36:15
#
#####################################################################
...
# Design Import
###########################################################
source ./p+r_enc/TopBagging_synth.globals
init_design


# Mode Setup
###########################################################
source ./p+r_enc/TopBagging_synth.mode

# Import list of instances with subdesigns having boundary optimization disabled
################################################################################
setOptMode -keepPort ./p+r_enc/TopBagging_synth.boundary_opto.tcl 


# Import list of size_only instances
######################################
setOptMode -sizeOnlyFile ./p+r_enc/TopBagging_synth.size_ok.tcl 
