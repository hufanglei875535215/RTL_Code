...
usage -auto -elapse
set log file fv/BaggingDemo/rtl_to_g1.log -replace
tclmode
...
elaborate design -golden -root BaggingDemo -rootonly \

tclmode
if {$ver < 13.10} {
vpx read design -verilog -revised -lastmod -noelab \
	-unzip fv/BaggingDemo/g1.v.gz
} else {
...
elaborate design -revised -root BaggingDemo
...
write hier_compare dofile fv/BaggingDemo/hier_rtl_to_g1.do \
...
run hier_compare fv/BaggingDemo/hier_rtl_to_g1.do -analyze_abort  -dynamic_hierarchy
